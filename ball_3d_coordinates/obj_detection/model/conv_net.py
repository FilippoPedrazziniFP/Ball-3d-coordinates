...
from tensorflow.python.keras.layers import Input, Conv2D, Activation, Dense, Flatten
...
class ConvNet(object):
    ...
    def build_model(self):
        ...
        x = Conv2D(16, (3, 3), padding="valid", strides=(2,2))(input_net)
        x = Activation('relu')(x)
        
        x = Conv2D(16, (3, 3), padding="valid", strides=(2,2))(x)
        x = Activation('relu')(x)
        
        x = Conv2D(32, (3, 3), padding="valid", strides=(2,2))(x)
        x = Activation('relu')(x)
