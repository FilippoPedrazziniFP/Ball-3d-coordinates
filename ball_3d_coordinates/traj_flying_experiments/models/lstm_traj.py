...
from tensorflow.python.keras.layers import TimeDistributed, Conv1D, Dense, LSTM
...
class LSTMTrajNet(object):
    ...
    def build_model(self):
        ...
        model.add(LSTM(256, return_sequences=False, input_shape=(self.input_trace, 3)))
        model.add(Dense(3))
        model.summary()

        model.compile(
            optimizer=Adam(),
            loss=LSTMTrajNet.root_mean_squared_error, 
            metrics=['mae'])
