...
from ball_3d_coordinates.traj_flying_experiments.preprocessing.data_preprocessing_flying import TmpFlyingPreprocessor
from ball_3d_coordinates.traj_flying_experiments.preprocessing.exploration import Visualizer
from ball_3d_coordinates.traj_flying_experiments.preprocessing.data_loader_flying import Loader
from ball_3d_coordinates.traj_flying_experiments.models.tmp_net_flying import TmpFlyingNet
...
def main():
    ...
    # Preprocess the data
    preprocessor = TmpFlyingPreprocessor(
